"""
Adapted from https://github.com/sighsmile/conlleval/tree/master
...
def get_result(correct_chunks, true_chunks, pred_chunks,
    ...
    # compute overall precision, recall and FB1 (default values are 0.0)
    prec, rec, f1 = calc_metrics(sum_correct_chunks, sum_pred_chunks, sum_true_chunks, False)
    res = (prec, rec, f1)
    if not verbose:
        return res
...
def evaluate(true_seqs, pred_seqs, verbose=False):
    """
    true_seqs: a list of true tags
    pred_seqs: a list of predicted tags
